...
CONFIGS = [
    ...
    cfg("hs14_aug_static_r1",  HS14, AUG; schedule = StaticContinuation(rho = 1.0, muP_max = 1e6)),
    cfg("hs14_con_fixed_1e3",  HS14, CON; muP = 1e3),
    cfg("hs14_con_static_r1",  HS14, CON; schedule = StaticContinuation(rho = 1.0, muP_max = 1e6)),
]
# ============================================================================
